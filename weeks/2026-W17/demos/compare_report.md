...
## Review Checklist
- [ ] **warning-on-muted**: Adjust warning-on-muted before release, it is 1.53 below the target ratio.
- [ ] **semantic.badge.info.bg**: Fix or remove the alias at semantic.badge.info.bg so the semantic token resolves cleanly.

## Token Diff
- Added: 2
- Removed: 0
- Changed: 8
- `colors.accent.brand`: `#4338ca` -> `#4f46e5`
- `colors.accent.warning`: `#b45309` -> `#d97706`
- `colors.border.subtle`: `#dbe4ee` -> `#cbd5e1`
- `colors.surface.inverse`: `#111827` -> `#0f172a`
- `colors.surface.muted`: `#f8fafc` -> `#f5f7fb`
- `colors.text.primary`: `#111827` -> `#0f172a`
- `colors.text.secondary`: `#64748b` -> `#475569`
- `typography.fontSize.hero`: `30px` -> `32px`
- `radius.pill`: added `999px`
- `semantic.badge.info.bg`: added `{colors.accent.info}`
